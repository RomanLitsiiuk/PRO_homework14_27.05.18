window.onload = function () {
  var Slider = function(rootElement, slideCount, slideScroll, cyclic) {
  ...
  Slider.prototype.size = function () {
    ...
    this.leftArrow.style.top = (this.slideHeight / this.sliderCount) / 2 + 'px';
    this.rightArrow.style.top = (this.slideHeight / this.sliderCount) / 2 + 'px';
  };
